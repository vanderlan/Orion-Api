...
using Invest.Api;
using Invest.Api.AutoMapper.Config;
using Invest.Api.Handler;
using Invest.Data.Context;
using Invest.Data.UnitOfWork;
using Invest.Service.Implementation;
...
using System.Text;
using static Invest.Service.Authentication.AuthenticationConfiguration;
